...
import bgImage1 from './assets/bg-image-1.png'
import bgImage2 from './assets/bg-image-2.png'
...
export default function App() {
  ...
  const [activeNav, setActiveNav] = useState<(typeof NAV_LINKS)[number]>('Course')
